...
REM PUT
curl -H "Content-Type: application/json" -X PUT "http://localhost:7001/TicketServer/webresources/card" -d {"""type""":"""add""","""uid""":"""FFFFFFFF""","""count""":10}
...
curl -H "Content-Type: application/json" -X PUT "http://localhost:7001/TicketServer/webresources/card" -d {"""type""":"""add""","""uid""":"""00000001""","""start_time""":"""20150801""","""end_time""":"""20150802""","""balance""":200.00,"""single_day""":"""y"""}

curl -H "Content-Type: application/json" -X PUT "http://localhost:7001/TicketServer/webresources/card" -d {"""type""":"""add""","""uid""":"""00000888""","""staff""":"""y"""}

REM POST
curl -H "Content-Type: application/json" -X POST "http://localhost:7001/TicketServer/webresources/card" -d {"""type""":"""check""","""uid""":"""FFFFFFFF""","""count""":1}
...
curl -H "Content-Type: application/json" -X POST "http://localhost:7001/TicketServer/webresources/card" -d {"""type""":"""check""","""uid""":"""FFFFFFF0""","""count""":1,"""valid_check""":"""y"""}
...
curl -H "Content-Type: application/json" -X POST "http://localhost:7001/TicketServer/webresources/card" -d {"""type""":"""check""","""uid""":"""0FFFFFFF""","""balance""":1.00,"""valid_check""":"""y"""}
